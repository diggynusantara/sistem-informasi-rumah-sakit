...
public class dataServis extends javax.swing.JFrame {
    ...
    final void tampilServis(){
        Vector judulTabel = new Vector();
        judulTabel.add("Kode Penyakit");
        judulTabel.add("Kode Klinik");
        judulTabel.add("Kode Dokter");
        judulTabel.add("Kode Perawat");
        judulTabel.add("Tarif");
        Vector isiTabel = ttm.tampilServis();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "LIST SERVIS", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
