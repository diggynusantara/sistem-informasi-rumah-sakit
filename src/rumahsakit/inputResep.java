 ...
 */
public class inputResep extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Kode Obat");

        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("Jumlah");

        jLabel22.setForeground(new java.awt.Color(255, 255, 255));
        jLabel22.setText("Kode Resep");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "== PILIH KODE OBAT ==" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (tanya == JOptionPane.OK_OPTION) {
            imt.inputResep(jTextField9.getText(),
    ...
    private void jTextField9FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField9FocusLost
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM resep WHERE KdRsp='" + jTextField9.getText() + "'");
            ...
            if (rs.next()) {
                ...
                if (tanya == JOptionPane.OK_OPTION) {
                    jComboBox1.setSelectedItem(rs.getString("KdObat"));
                    jTextField7.setText(rs.getString("Jumlah"));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if (tanya == JOptionPane.OK_OPTION){
        umt.updateResep(jTextField9.getText(),
                       (String)jComboBox1.getSelectedItem(),
                       jTextField7.getText());
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        if (tanya == JOptionPane.OK_OPTION){
        dmt.hapusResep(jTextField9.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inputResep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new inputResep().setVisible(true);
            }
        });
    }
