...
public class inputKlinik extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Masukkan Data Klinik", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N

        jPanel7.setBackground(new java.awt.Color(0, 0, 102));

        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("Nama Klinik");

        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("Ruang Klinik");

        jLabel22.setForeground(new java.awt.Color(255, 255, 255));
        jLabel22.setText("Kode Klinik");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (tanya == JOptionPane.OK_OPTION) {
            imt.inputKlinik(jTextField9.getText(),
                    jTextField6.getText(),
                    jTextField7.getText());
    ...
    private void jTextField9FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField9FocusLost
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM klinik WHERE KdKln='" + jTextField9.getText() + "'");
            ...
            if (rs.next()) {
                ...
                if (tanya == JOptionPane.OK_OPTION) {
                    jTextField6.setText(rs.getString("NmKln"));
                    jTextField7.setText(rs.getString("RngKln"));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if (tanya == JOptionPane.OK_OPTION){
        umt.updateKlinik(jTextField9.getText(),
                       jTextField6.getText(),
                       jTextField7.getText());
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        if (tanya == JOptionPane.OK_OPTION){
        dmt.hapusKlinik(jTextField9.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inputKlinik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new inputKlinik().setVisible(true);
            }
        });
    }
